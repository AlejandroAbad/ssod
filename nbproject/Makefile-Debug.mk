...
${OBJECTDIR}/datastructs/error.o: datastructs/error.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG_MODE -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/datastructs/error.o datastructs/error.c

${OBJECTDIR}/datastructs/iface.o: datastructs/iface.c 
	${MKDIR} -p ${OBJECTDIR}/datastructs
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG_MODE -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/datastructs/iface.o datastructs/iface.c

${OBJECTDIR}/datastructs/listener.o: datastructs/listener.c 
	${MKDIR} -p ${OBJECTDIR}/datastructs
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG_MODE -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/datastructs/listener.o datastructs/listener.c

${OBJECTDIR}/datastructs/realm.o: datastructs/realm.c 
	${MKDIR} -p ${OBJECTDIR}/datastructs
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG_MODE -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/datastructs/realm.o datastructs/realm.c

${OBJECTDIR}/datastructs/ssod.o: datastructs/ssod.c 
	${MKDIR} -p ${OBJECTDIR}/datastructs
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG_MODE -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/datastructs/ssod.o datastructs/ssod.c

${OBJECTDIR}/datastructs/thread.o: datastructs/thread.c 
	${MKDIR} -p ${OBJECTDIR}/datastructs
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG_MODE -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/datastructs/thread.o datastructs/thread.c

${OBJECTDIR}/debug.o: debug.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG_MODE -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/debug.o debug.c

${OBJECTDIR}/inih/ini.o: inih/ini.c 
	${MKDIR} -p ${OBJECTDIR}/inih
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG_MODE -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/inih/ini.o inih/ini.c

${OBJECTDIR}/main.o: main.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG_MODE -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.c

${OBJECTDIR}/watchers/network.o: watchers/network.c 
	${MKDIR} -p ${OBJECTDIR}/watchers
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG_MODE -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/watchers/network.o watchers/network.c

${OBJECTDIR}/wpa_ctrl/wpa_ctrl.o: wpa_ctrl/wpa_ctrl.c 
	${MKDIR} -p ${OBJECTDIR}/wpa_ctrl
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG_MODE -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wpa_ctrl/wpa_ctrl.o wpa_ctrl/wpa_ctrl.c
